...
SELECT br.borrow_id, m.name_of_member, b.book_id, b.title, a.name AS author_name, br.due_date, CASE WHEN CURRENT_DATE() < br.due_date THEN 'Pending' WHEN CURRENT_DATE() > br.due_date THEN 'Overdue' END AS return_status
